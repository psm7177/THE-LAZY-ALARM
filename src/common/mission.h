...
void press_buttons(int difficulty) {
    ...
    {
        scanf("%s", answer);
        if (strcmp(answer, "") == 0) count++;
        else if (strcmp(answer, "done") == 0) break;
        else {
...
void solve_equation(int difficulty) {
    ...
    {   
        ...
        if (strcmp(answer, response) == 0) break;
...
void exe_mission(mission_t *mission) {
    ...
    if (strcmp(mission->name, "press buttons") == 0) press_buttons(mission->difficulty);
    else if (strcmp(mission->name, "solve equation") == 0) solve_equation(mission->difficulty);
    else if (strcmp(mission->name, "type dictation") == 0) type_dictation(mission->difficulty);
    else if (strcmp(mission->name, "flash sensor") == 0) flash_sensor(mission->difficulty);
    else if (strcmp(mission->name, "tag card") == 0) tag_card(mission->difficulty);
